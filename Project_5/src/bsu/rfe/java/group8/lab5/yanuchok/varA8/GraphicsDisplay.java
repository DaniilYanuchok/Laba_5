package bsu.rfe.java.group8.lab5.yanuchok.varA8;
...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        float[] dashPattern = {10, 2, 4, 2, 4, 2, 6, 2, 2};
    ...
    protected void paintMarkers(Graphics2D canvas) {
		...
		for (double[] point: graphicsData) {
			...
			//path.append(new Line2D.Double(center.getX() + 5.5, center.getY() + 0, center.getX() - 5.5, center .getY() + 0), true);
			//path.append(new Line2D.Double(center.getX() + 0, center.getY() + 5.5, center.getX() + 0, center.getY() - 5.5), true);
			...
			path.moveTo(center.getX() + 5.5, center.getY() - 5.5);
			path.lineTo(center.getX() - 5.5, center.getY() + 5.5);
			path.moveTo(center.getX() - 5.5, center.getY() - 5.5);
			path.lineTo(center.getX() + 5.5, center.getY() + 5.5);
